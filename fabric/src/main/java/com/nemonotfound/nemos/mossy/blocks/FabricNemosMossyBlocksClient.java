...
public class FabricNemosMossyBlocksClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.putBlock(MOSSY_IRON_BARS.get(), ChunkSectionLayer.CUTOUT);
        ...
        BlockRenderLayerMap.putBlock(PALE_MOSSY_IRON_BARS.get(), ChunkSectionLayer.CUTOUT);
        ...
        BlockRenderLayerMap.putBlock(CRIMSON_MOSSY_IRON_BARS.get(), ChunkSectionLayer.CUTOUT);
        ...
        BlockRenderLayerMap.putBlock(WARPED_MOSSY_IRON_BARS.get(), ChunkSectionLayer.CUTOUT);
