...
public class ModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        BlockTexturePool mossyTuffTexturePool = blockStateModelGenerator.registerCubeAllModelTexturePool(MOSSY_TUFF);
        ...
        BlockTexturePool mossyTuffBricksTexturePool = blockStateModelGenerator.registerCubeAllModelTexturePool(MOSSY_TUFF_BRICKS);
