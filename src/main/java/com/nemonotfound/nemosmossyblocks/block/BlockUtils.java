...
public class BlockUtils {
    ...
    public static final Map<Block, Block> SHEARED_MOSSY_BLOCKS = new ImmutableMap.Builder<Block, Block>()
            ...
            .put(ModBlocks.MOSSY_SPRUCE_DOOR, Blocks.SPRUCE_DOOR)
            .put(ModBlocks.MOSSY_BIRCH_DOOR, Blocks.BIRCH_DOOR)
            .put(ModBlocks.MOSSY_JUNGLE_DOOR, Blocks.JUNGLE_DOOR)
            .put(ModBlocks.MOSSY_ACACIA_DOOR, Blocks.ACACIA_DOOR)
            .put(ModBlocks.MOSSY_DARK_OAK_DOOR, Blocks.DARK_OAK_DOOR)
            .put(ModBlocks.MOSSY_MANGROVE_DOOR, Blocks.MANGROVE_DOOR)
            .put(ModBlocks.MOSSY_CHERRY_DOOR, Blocks.CHERRY_DOOR)
            .put(ModBlocks.MOSSY_BAMBOO_DOOR, Blocks.BAMBOO_DOOR)
            .put(ModBlocks.MOSSY_CRIMSON_DOOR, Blocks.CRIMSON_DOOR)
            .put(ModBlocks.MOSSY_WARPED_DOOR, Blocks.WARPED_DOOR)
            .put(ModBlocks.MOSSY_IRON_DOOR, Blocks.IRON_DOOR)
            .put(ModBlocks.MOSSY_OAK_TRAPDOOR, Blocks.OAK_TRAPDOOR)
            .put(ModBlocks.MOSSY_SPRUCE_TRAPDOOR, Blocks.SPRUCE_TRAPDOOR)
            .put(ModBlocks.MOSSY_BIRCH_TRAPDOOR, Blocks.BIRCH_TRAPDOOR)
            .put(ModBlocks.MOSSY_JUNGLE_TRAPDOOR, Blocks.JUNGLE_TRAPDOOR)
            .put(ModBlocks.MOSSY_ACACIA_TRAPDOOR, Blocks.ACACIA_TRAPDOOR)
            .put(ModBlocks.MOSSY_DARK_OAK_TRAPDOOR, Blocks.DARK_OAK_TRAPDOOR)
            .put(ModBlocks.MOSSY_MANGROVE_TRAPDOOR, Blocks.MANGROVE_TRAPDOOR)
            .put(ModBlocks.MOSSY_CHERRY_TRAPDOOR, Blocks.CHERRY_TRAPDOOR)
            .put(ModBlocks.MOSSY_BAMBOO_TRAPDOOR, Blocks.BAMBOO_TRAPDOOR)
            .put(ModBlocks.MOSSY_CRIMSON_TRAPDOOR, Blocks.CRIMSON_TRAPDOOR)
            .put(ModBlocks.MOSSY_WARPED_TRAPDOOR, Blocks.WARPED_TRAPDOOR)
            .put(ModBlocks.MOSSY_IRON_TRAPDOOR, Blocks.IRON_TRAPDOOR)
            .build();
}
